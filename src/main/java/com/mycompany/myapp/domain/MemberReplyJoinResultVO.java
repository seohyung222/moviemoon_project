...
public class MemberReplyJoinResultVO {
	...
	public MemberReplyJoinResultVO(String id, String password, String name, String email, String movie_num,
	...
	public MemberReplyJoinResultVO() {
	}
	@Override
	public String toString() {
		return "MemberReplyJoinResultVO [id=" + id + ", password=" + password + ", name=" + name + ", email=" + email
				+ ", movie_num=" + movie_num + ", comment=" + comment + ", score=" + score + ", avgscore=" + avgscore
