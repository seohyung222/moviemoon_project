...
public class MovieDTO {
	...
	public void setViewdto(List<ViewDTO> viewdto) {
		this.viewdto = viewdto;
	}

	public MovieDTO(String movie_num, String title, String story, String actor, String director, String opening_day,
			String closing_day, Date registration_time, Date modification_time, String film_rate, String running_time,
			double avg_score, String movie_genre, List<ViewDTO> viewdto) {
		this.movie_num = movie_num;
		this.title = title;
		this.story = story;
		this.actor = actor;
	...
	public String toString() {
		return "MovieDTO [movie_num=" + movie_num + ", title=" + title + ", story=" + story + ", actor=" + actor
				...
				+ ", movie_genre=" + movie_genre + ", viewdto=" + viewdto + "]";
	}
